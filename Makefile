SRCS_MINISHELL = main.c parsing/parser.c execution/builtins.c execution/init_builtins1.c execution/init_builtins2.c execution/init_builtins3.c \
				...
				ft_helpers/ft_costum_split.c ft_helpers/utils_exe9.c ft_helpers/global_funcs5.c ft_helpers/utils_exe10.c ft_helpers/utils_exe11.c
OBJS_MINISHELL = $(SRCS_MINISHELL:.c=.o)
CC = cc
AR = ar r
RM = rm -f
CFLAGS = -Wall -Wextra -Werror -g -fsanitize=address -I$(HOME)/.local/include
