SRCS_MINISHELL = main.c parsing/parser.c execution/builtins.c execution/init_builtins1.c execution/init_builtins2.c execution/init_builtins3.c \
				...
				ft_helpers/utils_pars4.c ft_helpers/utils_signals.c parsing/ft_expand_tokens.c parsing/ft_init_env.c ft_helpers/utils_exe8.c ft_helpers/global_funcs4.c ft_helpers/utils_exe12.c \
