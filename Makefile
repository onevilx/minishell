SRCS_MINISHELL = main.c parsing/parser.c execution/builtins.c execution/init_builtins1.c execution/init_builtins2.c execution/init_builtins3.c \
				...
				ft_helpers/utils_pars5.c ft_helpers/utils_pars6.c ft_helpers/utils_pars7.c ft_helpers/utils_pars8.c ft_helpers/utils_pars9.c ft_helpers/utils_pars10.c \
